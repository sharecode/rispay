...
<h3><b>อัปเดทสถานะชำระเงิน</b></h3>
</div>

<div class="modal-body">

<form action="update/" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
<select name="pname" id="pname" class="form-control" required disabled="">
...
<input type="text" name="fname" id="fname" class="form-control" value="<?php echo $row['fname'] ?>" required disabled="">
</div>
</div>
...
<input type="text" name="lname" id="lname" class="form-control" value="<?php echo $row['lname'] ?>" required disabled="">
</div>
</div>
...
<input type="text" name="idcd" id="idcd" class="form-control" value="<?php echo $row['idcd'] ?>" maxlength="13"  required disabled="">
</div>
</div>
...
<input type="text" name="position" id="cneu" class="form-control" value="<?php echo $row['position'] ?>" maxlength="10" disabled="" >
</div>
</div>
...
<input type="text" name="tel" id="tel" class="form-control" value="<?php echo $row['tel'] ?>" maxlength="10" required disabled="">
</div>
</div>
...
<input type="text" name="dep" id="dep" class="form-control" value="<?php echo $row['dep'] ?>" required disabled="">
</div>
</div>

<div class="form-group">
<div class="input-group">
<select name="prv" id="prv" class="form-control" required disabled="">
...
<select name="chk" id="chk" class="form-control" required>
