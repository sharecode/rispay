...
<input type="text" size="30" value="<?php echo $row['mndate'] ?>" name="mndate" id="jQueryUICalendar1" class="form-control"  placeholder="กรุณาคลิกเลือกวันที่ (ที่ระบุในใบทำรายการ)" required>
</div>
